function [conf, RT] = collectConfidence_selfPaced_withCue_RedGreen(window,p,cueWord,totalPoints,confCondition)
...
while true
    ...
    if confCondition == 1
        DrawFormattedText(curWindow,'Confidence WITHOUT hint?','center',center(2)+VASoffset+100,[255 0 0]);
    else
        DrawFormattedText(curWindow,'Confidence WITH hint?','center',center(2)+VASoffset+100,[0 255 0]);
    end
