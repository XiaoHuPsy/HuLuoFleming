% Fit the winning model to data and record estimated confidence rating (confpre)
clear;

%% load data and model name
modelName = {'confModel_beta0_2.txt'}; % name of the winning model

parentFolder = fileparts(pwd);
dataName = 'modelfit_data_Confidence_Exp3.mat'; % load data for Experiment 3
...
for i=1:length(modelName)
    ...
    monitorParams = {'groupUbeta0','groupVbeta0','groupUbias','groupVbias','sigmaconf','beta0','beta1','bias','confpre'};
