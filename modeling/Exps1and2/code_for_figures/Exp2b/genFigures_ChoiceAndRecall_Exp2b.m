...
load stat_negative_2C_2Phinto_Exp2b % parameters in the winning model
load modelfit_data_ChoiceAndRecall_Exp2b % data of choice and recall performance
load prec_Exp2b % predicted memory strength in the winning model
load recData_Exp2b % overall recall performance
load askPropData_Exp2b % overall ask-for-help proportions
